      ...
      <div className="collapse navbar-collapse" id="navbarNav">
        <ul className="navbar-nav ml-auto"style={{'paddingRight':50+'px'}}>
            ...
            {auth.isAuthenticated
              ...
              <li id="Logout"key="2" className="nav-item navListItems"><Link to='/' className="nav-link" onClick={() => logout()}>Logout</Link></li>]
              : [
                <li id="Log"key="3" className="nav-item navListItems" ><Link onClick={this.toggleBurger} className="nav-link" to='/login'>Login</Link></li>,
                <li id="Reg"key="4" className="nav-item navListItems" ><Link onClick={this.toggleBurger} className="nav-link" to='/register'>Register</Link></li>
              ]
            }
          </ul>
        </div>
